 ...
 *
 * ⚠️ 入参是**自由文本**（OCR 字面文本 / 商户名 / 备注），不是分类标签。
 * 因此只保留**低歧义**词根；分类标签的别名映射请用
 * [com.palmnote.data.export.BillCsvImporter.normalizeCategory]（其专用别名表）。
 */
    ...
    fun guessCategory(text: String): String {
        return when {
            text.containsAny(
                ...
                "快餐", "夜宵", "早餐", "午餐", "晚餐", "聚餐",
                "汉堡", "披萨", "米线", "饺子", "包子", "肯德基", "麦当劳",
                "必胜客", "瑞幸", "星巴克", "喜茶", "蜜雪", "甜品", "蛋糕",
                "烘焙", "卤味", "自助餐", "生鲜", "盒马", "美食"
            ) -> "餐饮"
            ...
            text.containsAny(
                ...
                "出租", "滴滴", "过路费", "洗车", "保养", "高速",
                "火车票", "共享单车", "单车", "高德", "哈啰", "12306", "乘车码"
            ) -> "交通"

            text.containsAny(
                "超市", "购物", "商场", "便利店", "百货", "淘宝", "京东",
                "拼多多", "天猫", "日用", "生活用品", "生活日用品", "日化",
                "网购", "快递", "抖音", "严选", "名创", "菜市场", "唯品会", "服饰", "装扮"
            ) -> "购物"
            ...
            text.containsAny(
                "水电", "燃气", "物业", "房租", "宽带", "房贷", "租房", "暖气", "住房"
            ) -> "居住"

            text.containsAny("红包") -> "红包"
            ...
            text.containsAny("健身", "瑜伽", "游泳", "运动", "体育馆", "跑步", "户外") -> "运动"
            ...
            text.containsAny(
                "电影", "游戏", "KTV", "演出", "门票", "乐园", "娱乐",
                "视频", "点券", "爱奇艺", "优酷", "哔哩", "网易云", "音乐",
                "直播", "Steam", "steam"
            ) -> "娱乐"
            ...
            text.containsAny("通讯", "电话费", "流量", "话费", "中国移动", "中国电信", "中国联通") -> "通讯"
