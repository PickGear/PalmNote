...
@Composable
fun TravelListScreen(templateId: Long, onBack: () -> Unit, onItemClick: (Long) -> Unit, onCreateClick: () -> Unit = {}, viewModel: TravelPlanViewModel = simpleViewModel { PalmNoteApp.container.travelPlanViewModel() }) {
