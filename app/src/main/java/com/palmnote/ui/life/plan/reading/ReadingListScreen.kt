...
@Composable
fun ReadingListScreen(templateId: Long, onBack: () -> Unit, onItemClick: (Long) -> Unit, onCreateClick: () -> Unit = {}, viewModel: ReadingPlanViewModel = simpleViewModel { PalmNoteApp.container.readingPlanViewModel() }) {
