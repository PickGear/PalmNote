...
@Composable
fun BirthdayListScreen(templateId: Long, onBack: () -> Unit, onItemClick: (Long) -> Unit, onCreateClick: () -> Unit = {}, viewModel: BirthdayViewModel = simpleViewModel { PalmNoteApp.container.birthdayViewModel() }) {
