...
class ReportViewModel @Inject constructor(
    ...
    fun previousYear() {
        val year = _state.value.currentYear.toIntOrNull() ?: return
        _state.value = _state.value.copy(currentYear = (year - 1).toString())
        loadData()
    }
    ...
    private fun loadData() {
        ...
        dataJob = viewModelScope.launch {
            ...
            val isExpense = snapshot.incomeExpenseTab == 0
            when (snapshot.periodTab) {
